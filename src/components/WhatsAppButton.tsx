...
export default function WhatsAppButton() {
  const message = encodeURIComponent("Hello, I would like to book a dental consultation.");
  const whatsappUrl = `https://wa.me/${CLINIC_INFO.whatsapp.replace(/[^0-9]/g, '')}?text=${message}`;
