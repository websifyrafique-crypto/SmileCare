...
export const PROBLEMS = [
  { title: 'Toothache', desc: 'Severe or throbbing pain, often indicating a deep cavity or infection needing a root canal.', image: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=400&q=80' },
  ...
  { title: 'Gum Disease', desc: 'Bleeding, swollen gums causing bad breath. Treated with professional deep scaling and root planing.', image: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=400&q=80' },
  { title: 'Crooked Teeth', desc: 'Misaligned teeth affecting your bite and smile. Corrected using braces or clear aligners.', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=400&q=80' },
